...
const Footer = () => {
  return (
    <div className="mb-0">
      ...
      <footer className="footer px-10 py-4 border-t bg-blue-600 text-base-content border-base-300">
        <div className="items-center grid-flow-col">
          ...
          <p className="text-white">
            Phone-Bazar Industries Ltd. <br />
            Providing reliable used tech since 2022
          </p>
        </div>
